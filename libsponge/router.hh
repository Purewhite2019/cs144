...
class Router {
    ...
    //* <<route_prefix(shifted), prefix_length>, <next_hop, interface_num>>
    std::vector<std::pair<std::pair<uint32_t, uint8_t>, std::pair<std::optional<Address>, size_t>>> _routing_table{};
